...
ages2plot <- 0:18
fitPlot(fitTypical.unharvested,xlab="Age",ylab="Total Length (mm)",xlim=range(ages2plot), ylim = c(0, 120),main="Unharvested")
...
ages2plot <- 0:18
fitPlot(fitTypical.harvested,xlab="Age",ylab="Total Length (mm)",xlim=range(ages2plot),main="Harvested")
LCI <- UCI <- numeric(length(ages2plot))
