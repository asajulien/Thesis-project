...
wilcox.test(Length.mm ~ Status, data = site_compare[site_compare$Date == "2/6/2017",])
wilcox.test(Length.mm ~ Status, data = site_compare[site_compare$Date == "5/18/2017",])
...
wilcox.test(Growth.bands ~ Status, data = site_compare[site_compare$Date == "2/6/2017",])
wilcox.test(Growth.bands ~ Status, data = site_compare[site_compare$Date == "5/18/2017",])
