...
pcent_feb = ggplot(data = feb_compare, aes(x = Length.mm)) + geom_histogram(aes(y=(..count..)/tapply(..count..,..PANEL..,sum)[..PANEL..]), binwidth = 5) + facet_grid(.~Status) + theme_bw() + labs(x = "Length (mm)", y="Frequency (%)") 
...
pcent_may = ggplot(data = may_compare, aes(x = Length.mm)) + geom_histogram(aes(y=(..count..)/tapply(..count..,..PANEL..,sum)[..PANEL..]), binwidth = 5) + facet_grid(.~Status) + theme_bw() + labs(x = "Length (mm)", y="Frequency (%)") 
