...
xxx1 = ggplot(data = f_m, aes(x = Length.mm)) + geom_histogram(data = f_m[f_m$Status == "Harvested",], fill = 1, alpha = 1, aes(y=(..count..)/tapply(..count..,..PANEL..,sum)[..PANEL..] * 100), binwidth = 5) + facet_grid(.~Date) + theme_bw() + labs(x = "", y="Frequency (%)", title = "") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15, colour = "black"), strip.text = element_text(size = 15, colour = "black"), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) + scale_x_continuous(breaks = c(seq(0, 100, 50)), expand = c(0,0)) + scale_y_continuous(breaks = seq(0, 20, 5), limits = c(0,21), expand = c(0,0)) + geom_vline(xintercept = 76.2, lty = "dashed") + ggtitle("Fish Creek - Harvested")

yyy1 = ggplot(data = f_m, aes(x = Length.mm)) + geom_histogram(data = f_m[f_m$Status == "Unharvested",], fill = 1, alpha = 1, aes(y=(..count..)/tapply(..count..,..PANEL..,sum)[..PANEL..] * 100), binwidth = 5) + facet_grid(.~Date) + theme_bw() + labs(x = "", y="Frequency (%)", title = "") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15, colour = "black"), strip.text = element_text(size = 15, colour = "black"), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) + scale_x_continuous(breaks = c(seq(0, 100, 50)), expand = c(0,0)) + scale_y_continuous(breaks = seq(0, 20, 5), limits = c(0,21), expand = c(0,0)) + geom_vline(xintercept = 76.2, lty = "dashed") + ggtitle("St. Pierre Creek - Unharvested")
