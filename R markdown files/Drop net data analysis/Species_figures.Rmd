...
p_seasabun = ggplot(abun_season, aes(Season, Abundance, fill = Treatment)) + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Abundance + SE.abun, ymin = Abundance-SE.abun), width=0.25, position = position_dodge(.9)) + labs(x = "", y = expression(Nekton~abundance~(individuals~m^{-2}))) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 10, face = "bold", colour = "black"), strip.text = element_text(size = 10, face = "bold", colour = "black"), axis.text.x = element_text(size=9, colour = "black"), axis.text.y = element_text(size = 10, colour = "black")) + ylim(0,25) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "") + scale_x_discrete(labels = c("Fall", "Winter", "Spring"))
...
p_seasshan = ggplot(shan_season, aes(Season, Shannon, fill = Treatment)) + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Shannon+SE.shan, ymin = Shannon-SE.shan), width=0.25, position = position_dodge(.9)) + labs(x = "", y = "Shannon's diversity index") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 10), strip.text = element_text(size = 10), axis.text.x = element_text(size=9, colour = "black"), axis.text.y = element_text(size = 10, colour = "black")) + ylim(0,1) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "") + scale_x_discrete(labels = c("Fall", "Winter", "Spring"))
...
p_seassimp = ggplot(simp_season, aes(Season, Simpson, fill = Treatment)) + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Simpson + SE.simp, ymin = Simpson - SE.simp), width = 0.25, position = position_dodge(.9)) + labs(x = "", y = "Simpson's diversity index") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 10), strip.text = element_text(size = 10, face = "bold"), axis.text.x = element_text(size=9, colour = "black"), axis.text.y = element_text(size = 10, colour = "black")) + ylim(0,0.6) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "") + scale_x_discrete(labels = c("Fall", "Winter", "Spring"))
...
p_seasrich = ggplot(rich_season, aes(Season, Richness, fill = Treatment)) + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Richness + SE.rich, ymin = Richness - SE.rich), width = 0.25, position = position_dodge(.9)) + labs(x = "", y = "Species richness") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 10), strip.text = element_text(size = 15), axis.text.x = element_text(size=9, colour = "black"), axis.text.y = element_text(size = 10, colour = "black")) + ylim(0,4) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "") + scale_x_discrete(labels = c("Fall", "Winter", "Spring"))
