...
ggplot(phys_frame, aes(Order, Temperature)) + geom_point() + scale_x_discrete(breaks = c(5,16,25), labels=c("July - October 2016","November 2016 - April 2017","April - August 2017")) + xlab("Range of sampling dates") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=10, colour = "black"), axis.text.y = element_text(size = 15, colour = "black"), axis.ticks.x = element_blank(), legend.position = "none") +ylab("Temperature (°C)") + geom_rect(aes(xmin = 0.75, xmax = 11.25, ymin = 0, ymax = Inf), alpha = 0.005) + geom_rect(aes(xmin = 22.75, xmax = 28.25, ymin = 0, ymax = Inf), alpha = 0.005) + scale_y_continuous(expand = c(0,0.25)) + geom_text(aes(x = 4, y = 2, label = "Fall 2016")) + geom_text(aes(x = 15, y = 2, label = "Winter 2017")) + geom_text(aes(x = 25.5, y = 2, label = "Spring 2017"))
