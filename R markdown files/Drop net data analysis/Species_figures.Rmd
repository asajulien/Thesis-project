...
colnames(abun_season) = c("Plot type", "Season", "Abundance", "SE.abun")
...
ggplot(data = csap_df, aes(Total.Length..mm.)) + geom_histogram(binwidth = 5) + labs(x = "Length (mm)", y = "Frequency (number)") + facet_grid(~Season) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15), axis.text.y = element_text(size = 15)) + ylim(0,15)
