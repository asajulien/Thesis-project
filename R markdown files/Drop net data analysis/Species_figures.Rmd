...
p_seasabun + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Abundance + SE.abun, ymin = Abundance-SE.abun), width=0.25, position = position_dodge(.9)) + labs(x = "", y = expression(Nekton~abundance~(individuals~m^{-2}))) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15, face = "bold", colour = "black"), strip.text = element_text(size = 15, face = "bold", colour = "black"), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) + ylim(0,25) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "A.")
...
p_seasshan + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Shannon+SE.shan, ymin = Shannon-SE.shan), width=0.25, position = position_dodge(.9)) + labs(x = "", y = "Shannon's diversity index") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) + ylim(0,1) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "B.")
...
p_seassimp + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Simpson + SE.simp, ymin = Simpson - SE.simp), width = 0.25, position = position_dodge(.9)) + labs(x = "", y = "Simpson's diversity index") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15, face = "bold"), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) + ylim(0,0.6) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "C.")
...
p_seasrich + geom_bar(position = position_dodge(), stat="identity", colour = 'black') + geom_errorbar(aes(ymax = Richness + SE.rich, ymin = Richness - SE.rich), width = 0.25, position = position_dodge(.9)) + labs(x = "", y = "Species richness") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) + ylim(0,4) + scale_fill_grey() + theme(legend.title=element_blank()) + scale_y_continuous(expand = c(0,0)) + labs(title = "D.")
```
...
ggplot(phys_frame, aes(Order, Temperature)) + geom_point() + scale_x_discrete(breaks = c(6,16,25), labels=c("Fall 2016","Winter 2017","Spring 2017")) + xlab(NULL) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black"), axis.ticks.x = element_blank(), legend.position = "none") +ylab("Temperature (°C)") + geom_rect(aes(xmin = 0.75, xmax = 11.25, ymin = 0, ymax = Inf), alpha = 0.005) + geom_rect(aes(xmin = 22.75, xmax = 28.25, ymin = 0, ymax = Inf), alpha = 0.005) + scale_y_continuous(expand = c(0,0.25)) + geom_text(aes(x = 4, y = 5, label = "Aug - Oct 2016")) + geom_text(aes(x = 15, y = 5, label = "Nov 2016 - Apr 2017")) + geom_text(aes(x = 25.5, y = 5, label = "Apr - Aug 2017"))

with(phys_frame, plot(Salinity ~ Order, pch = 16))
with(phys_frame, plot(CharlestonHeight ~ Order, pch = 16))

ggplot(phys_frame, aes(Order, Abun)) + geom_point() + scale_x_discrete(breaks = c(5,15,25), labels=c("Fall 2016","Winter 2017","Spring 2017")) + labs(x = NULL, y = expression(Nekton~abundance~(individuals~m^{-2}))) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15, colour = "black"), axis.text.y = element_text(size = 15, colour = "black"), axis.ticks.x = element_blank(), legend.position = "none") + geom_rect(aes(xmin = 0.75, xmax = 11.25, ymin = 0, ymax = Inf), alpha = 0.005) + geom_rect(aes(xmin = 22.75, xmax = 28.25, ymin = 0, ymax = Inf), alpha = 0.005) + scale_y_continuous(expand = c(0,1)) + geom_text(aes(x = 4, y = 125, label = "Aug - Oct 2016")) + geom_text(aes(x = 15, y = 125, label = "Nov 2016 - Apr 2017")) + geom_text(aes(x = 25.5, y = 125, label = "Apr - Aug 2017"))
