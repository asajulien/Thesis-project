...
new.df$Month<-factor(new.df$Month, levels = c("July","August","September","October","November","December", "January", "February", "March", "April", "May", "June")) #Ordering the months


##0barplots of averages:
df.abundance = new.df %>%
