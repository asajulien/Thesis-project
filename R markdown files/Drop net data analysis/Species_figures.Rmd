...
compare.abun + geom_bar(stat="identity", width = 0.5) + geom_errorbar(aes(ymax=Abundance+SE.abun,ymin=Abundance-SE.abun), width=0.15) + labs(x=expression(),y=expression(Nekton~abundance~(individuals~m^{-2}))) + theme(axis.title = element_text(size = 20,face = "bold"), strip.text = element_text(size=18,face = "bold"), axis.text.x = element_text(size=18,face = "bold"), axis.text.y = element_text(size = 13, face = "bold"))
...
compare.simp + geom_bar(stat="identity", width = 0.5) + geom_errorbar(aes(ymax=Simpson+SE.simpson,ymin=Simpson-SE.simpson), width=0.15) + labs(x=expression(),y=expression(Simpson~diversity)) + theme(axis.title = element_text(size = 20,face = "bold"), strip.text = element_text(size=18,face = "bold"), axis.text.x = element_text(size=18,face = "bold"), axis.text.y = element_text(size = 13, face = "bold"))
...
#ANCOVA, abundance#####################################
new.df$Month<-factor(new.df$Month, levels = c("July","August","September","October","November","December", "January", "February")) #Ordering the months
