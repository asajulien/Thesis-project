...
p_seasabun + geom_bar(stat="identity") + geom_errorbar(aes(ymax = Abundance + SE.abun, ymin = Abundance-SE.abun), width=0.25) + facet_grid(~Season) + labs(x = expression(Treatment), y = expression(Nekton~abundance~(individuals~m^{-2}))) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15, face = "bold"), strip.text = element_text(size = 15, face = "bold"), axis.text.x = element_text(size=10), axis.text.y = element_text(size = 15)) + ylim(0,25)
...
p_seassimp + geom_bar(stat="identity") + geom_errorbar(aes(ymax = Simpson + SE.simp, ymin = Simpson - SE.simp), width = 0.25) + facet_grid(~Season) + labs(x = "Treatment", y = "Simpson diversity index") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15, face = "bold"), strip.text = element_text(size = 15, face = "bold"), axis.text.x = element_text(size=10), axis.text.y = element_text(size = 15)) + ylim(0,0.8)
...
p_seasrich + geom_bar(stat="identity") + geom_errorbar(aes(ymax = Richness + SE.rich, ymin = Richness - SE.rich), width = 0.25) + facet_grid(~Season) + labs(x = "Treatment", y = "Species richness") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15, face = "bold"), strip.text = element_text(size = 15, face = "bold"), axis.text.x = element_text(size=10), axis.text.y = element_text(size = 15)) + ylim(0,4)
```
...
ggplot(data = csap_df, aes(Total.Length..mm.)) + geom_histogram(binwidth = 5) + facet_grid(.~Month) + labs(x = "Length (mm)", y = "Frequency (number)") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15, face = "bold"), strip.text = element_text(size = 10, face = "bold"), axis.text.x = element_text(size=10), axis.text.y = element_text(size = 15)) + ylim(0,15)
...
```{r}
phys_frame = new_df %>%
  select(Date, Month, Temperature, Salinity, CharlestonHeight)
phys_frame = unique(phys_frame)
phys_frame$Date = as.Date(phys_frame$Date)

phys_frame$Order = as.factor(seq(1:28))


ggplot(phys_frame, aes(Order, Temperature)) + geom_point() + scale_x_discrete(breaks = c(5,15,25), labels=c("Fall 2016","Winter 2017","Spring 2017")) + xlab(NULL) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15), axis.text.y = element_text(size = 15)) +ylab("Temperature (°C)")
