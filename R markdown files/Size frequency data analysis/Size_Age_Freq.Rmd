...
#ggplot, by month
fbcp_freq$Month.code = factor(fbcp_freq$Month.code, levels = c("August","September","October","November","December", "January", "February", "March", "April", "May")) #reordering the months
...
svTypical.fbcp = list(Linf = 113.71, K = 0.28, t0 = -0.63) #using same Linf variable - CAREFUL
svTypical.fbcp
...
boot_nls1 <- nls(boot_fbcp, start = list(boot_Linf = 113.71, boot_K = 0.28, boot_t0 = -0.63), data = boot_df)
