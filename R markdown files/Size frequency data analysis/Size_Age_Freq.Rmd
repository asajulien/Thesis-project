...
mn.lines = data.frame(Month.code = c("August", "September", "October", "November", "December", "January", "February"), mn.size = c(81.03, 83.34, 86.32, 87.51, 75.92, 80.25, 85.18)) #visualizing the averages
...
svTypical.fbcp <- list(Linf = 114.0762063, K = 0.2788971, t0 = -0.6052945) #using same Linf variable - CAREFUL
svTypical.fbcp
