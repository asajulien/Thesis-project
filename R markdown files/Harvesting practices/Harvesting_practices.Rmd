...
p_mass + geom_bar(stat = "identity", width = 0.7) + geom_errorbar(aes(ymin = Wt - se.wt, ymax = Wt + se.wt), width = 0.1) + labs(x = "Harvest treatment", y = expression(Aboveground~italic(Spartina~alterniflora)~biomass~(g))) + annotate("text", x = "Full", y = 62, label = "*", size = 10)  + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 13), strip.text = element_text(size = 13), axis.text.x = element_text(size=15), axis.text.y = element_text(size = 15)) + scale_y_continuous(expand = c(0,0))
> dev.off()
...
ggplot(stems, aes(y = Length, x = Treatment)) + geom_boxplot() + labs(x = "Harvest treatment", y = expression(italic(Spartina~alterniflora)~stem~length~(mm))) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15), axis.text.y = element_text(size = 15))
...
ggplot(flower_mn, aes(Treatment, mn_flower)) + geom_bar(stat = "identity", width = 0.7) + geom_errorbar(aes(ymin = mn_flower - se_flower, ymax = mn_flower + se_flower), width = 0.1) + ylab("Percent of stems flowering") + xlab("Harvest treatment") + annotate("text", x = "Full", y = 9.5, label = "*", size = 10) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.title = element_text(size = 15), strip.text = element_text(size = 15), axis.text.x = element_text(size=15), axis.text.y = element_text(size = 15)) + scale_y_continuous(expand = c(0,0))
