...
p_mass + geom_point() + geom_errorbar(aes(ymin = Wt - se.wt, ymax = Wt + se.wt), width = 0.1) + labs(x = "", y = "Weight (g)") + annotate("text", x = "Full", y = 62, label = "*", size = 10)
...
ggplot(flower_mn, aes(Treatment, mn_flower)) + geom_point() + geom_errorbar(aes(ymin = mn_flower - se_flower, ymax = mn_flower + se_flower), width = 0.1) + ylab("Percent flowering") + annotate("text", x = "Full", y = 9.5, label = "*", size = 10)
