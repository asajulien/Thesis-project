...
12290/(108*132)
#AUC = 86.2%... maybe I did something wrong with the graph??
# "Why does this work? May have seen in 607 that Mann-Whitney statistic is equivalent to probability of correctly selecting the higher of a pair of numbers, which is equivalent to the definition of the AUC of an ROC curve"
```
