...
#interaction:
elev_int = update(elev_x5, . ~ . * salinity)

anova(full_x, elev_x, test='LRT')
AIC(full_x, elev_x)

anova(full_x, elev_x, elev_x2, elev_x4, elev_x5, elev_x6, elev_x7, elev_x8, elev_int, test='LRT')
AIC(full_x, elev_x2, elev_x3, elev_x4, elev_x5, elev_x6, elev_x7, elev_x8, elev_int) #model 5 is the best, no evidence for interaction
anova(elev_x5, elev_int, test = 'LRT')
