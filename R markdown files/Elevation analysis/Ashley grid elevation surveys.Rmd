...
fit_mhw = elev_mhw4$fitted.values
fit_mhw2 = elev_mhw4$fitted.values[ashgrid$Block == "20-25"]
fit_mhw3 = elev_mhw4$fitted.values[ashgrid$Block == "15-20"]
fit_mhw4 = elev_mhw4$fitted.values[ashgrid$Block == "10-15"]
fit_mhw5 = elev_mhw4$fitted.values[ashgrid$Block == "5-10"]
...
ashgrid$prob2 = fit_mhw2
ashgrid$prob3 = fit_mhw3
ashgrid$prob4 = fit_mhw4
ashgrid$prob5 = fit_mhw5

g = roc(Mussel.presence ~ prob, data = ashgrid)
g2 = roc(Mussel.presence ~ prob2, data = ashgrid)
g3 = roc(Mussel.presence ~ prob3, data = ashgrid)
g4 = roc(Mussel.presence ~ prob4, data = ashgrid)
g5 = roc(Mussel.presence ~ prob5, data = ashgrid)
...
auc(g3)
auc(g4)
auc(g5) #Not good for this model, I don't think. Bad at getting things right within a specific salinity block. Experiment with making salinity continuous? Elevation model 2 might be better than elevation model 4, but you should double check with somebody more experienced.
