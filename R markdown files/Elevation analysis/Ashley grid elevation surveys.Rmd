...
#plotting data and values predicted by models
new_data = data.frame(MHW = seq(-1.2, .2, length.out = 50), Block = rep(c("20-25"), each = 50))
new_data2 = data.frame(MHW = seq(-1.2, .2, length.out = 50), Block = rep(c("15-20"), each = 50))
new_data3 = data.frame(MHW = seq(-1.2, .2, length.out = 50), Block = rep(c("10-15"), each = 50))
new_data4 = data.frame(MHW = seq(-1.2, .2, length.out = 50), Block = rep(c("5-10"), each = 50))
...
lines(new_data$MHW, predict(elev_mhw4, newdata=new_data, type='response'),
      col='green')
lines(new_data2$MHW, predict(elev_mhw4, newdata=new_data2, type='response'),
      col='red')
lines(new_data3$MHW, predict(elev_mhw4, newdata=new_data3, type='response'),
      col='black')
lines(new_data4$MHW, predict(elev_mhw4, newdata=new_data4, type='response'),
      col='blue')

lines(new_data$MHW, predict(elev_mhw, newdata=new_data, type='response'),
      col='purple')
lines(new_data$MHW, predict(elev_mhw2, newdata=new_data, type='response'),
      col='pink')
