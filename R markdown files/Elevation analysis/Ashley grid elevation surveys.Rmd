...
#interaction:
elev_int = update(elev_x4, . ~ . * salinity)
elev_int2 = update(elev_x, . ~ . + I(salinity^2))

anova(full_x, elev_x, test='LRT')
AIC(full_x, elev_x)

anova(full_x, elev_x, elev_x2, elev_x4, elev_int, elev_x5, elev_int2, test='LRT')
AIC(full_x, elev_x2, elev_x3, elev_x4, elev_x5, elev_x6, elev_x7, elev_x8, elev_int, elev_int2) #model 5 is the best, no evidence for interaction
