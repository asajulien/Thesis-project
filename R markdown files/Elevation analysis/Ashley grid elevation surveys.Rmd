...
lines(new_data$MHW, predict(elev_mhw4, newdata=MHW_data, type='response'),
      col='green')
lines(new_data2$MHW, predict(elev_mhw4, newdata=MHW_data2, type='response'),
      col='red')
lines(new_data3$MHW, predict(elev_mhw4, newdata=MHW_data3, type='response'),
      col='black')
lines(new_data4$MHW, predict(elev_mhw4, newdata=MHW_data4, type='response'),
      col='blue')
